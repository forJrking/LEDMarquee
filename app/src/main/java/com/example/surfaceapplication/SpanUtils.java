...
//        jmethodID methodId = env->GetStaticMethodID(at_class, "currentApplication","()Landroid/app/Application;");
//        jobject context = env->CallStaticObjectMethod(at_class, methodId);
        Object invoke = null;
        try {
